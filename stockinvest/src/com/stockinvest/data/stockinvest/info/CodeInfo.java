...
public class CodeInfo extends CommonInfo implements Serializable{
	...
	private String codeName;	//종목명
	private String codeNum;		//종목코드번호
	private String juju;		//주주
	 ...
	 * @return the juju
	 */
	public String getJuju() {
		return juju;
	}
	/**
	 * @param juju the juju to set
	 */
	public void setJuju(String juju) {
		this.juju = juju;
	}
	/**
	 * @return the tel
	...
	/**
	 * @return the holdShare
	 */
	public String getHoldShare() {
		return holdShare;
	}
	/**
	 * @param holdShare the holdShare to set
	 */
