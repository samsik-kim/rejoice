...
<link type="text/css" href="<c:url value="/resource/jquery-ui-themes-1.9.0/themes/base/jquery.ui.all.css"/>" rel="stylesheet" />
<head>
...
$(document).ready(function () {
	...
	$('#fromDate').datepicker({
		defaultDate:new Date(2012, 10, 27)
	});
	$('#endDate').datepicker({
...
<input type="text" id="fromDate" /> <input type="text" id="endDate" />
<hr/>
...
<tr style="background:white">
	<td>예제</td>
	<td>
<form name="loginForm" method="post" action="/sample/js.do" onsubmit="return showValidate('loginForm', 'alert', '입력 오류가 있습니다.')">
        ...
        <div id="extDiv">
        <input type="text" name="divT" value="aaaaaa" v:required m:required="입력하십시오."/>
        </div>
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="requiredSampleForm" method="post" action="/sample/js.do" onsubmit="return showValidate('requiredSampleForm', 'dialog', '입력 오류가 있습니다.')">
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="mustcheckSampleForm" method="post" action="/sample/js.do" onsubmit="return showValidate('mustcheckSampleForm', 'dialog', '입력오류를 확인하십시오.')">
				        성별
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="mustnumSampleForm" method="post" action="/sample/js.do" onsubmit="return showValidate('mustnumSampleForm', 'dialog', '다시 입력하세요.')">
				        나이
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="ncompareSampleForm" method="post" action="/sample/js.do" onsubmit="return showValidate('ncompareSampleForm', 'dialog', '다시 입력하세요.')">
				        18금 통과 나이는?
				          <input type="text" name="age"
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="emailSampleForm" method="post" action="/sample/js.do" onsubmit="return showValidate('emailSampleForm', 'dialog', '다시 입력하세요.')">
				        이메일
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="dateSampleForm" method="post" action="/sample/js.do" onsubmit="return showValidate('dateSampleForm', 'dialog', '다시 입력하세요.')">
				        시작일
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="regexpSampleForm" method="post" action="/sample/js.do" onsubmit="return showValidate('regexpSampleForm', 'dialog', '다시 입력하세요.')">
				        ID
	...
	<td>
		...
		<tr style="background:white">
			...
			<td>
				...
				<form name="dayTermLimitForm" method="post" action="/sample/js.do" onsubmit="return showValidate('dayTermLimitForm', 'dialog', '조회기간 오류')">
				        조회 기간 : 
				          <input type="text" name="startDate"
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="textLimitForm" method="post" action="/sample/js.do" onsubmit="return showValidate('textLimitForm', 'dialog', '입력제한 오류')">
					<textarea name="note"
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="shotypeAlertSampleForm" method="post" action="/sample/js.do" onsubmit="return showValidate('shotypeAlertSampleForm', 'alert', '잘못했을껄?')">
				<table>
				<tr>
				    <td align="right">
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="shotypeDialogSampleForm" method="post" action="/sample/js.do" onsubmit="return showValidate('shotypeDialogSampleForm', 'dialog', '오류다이얼로그제목')">
				<table>
				<tr>
				    <td align="right">
				        <span style="color:red">*</span>ID
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>묵시적인 지정 예제</td>
			<td>
				<form name="shotypeEtc1SampleForm" method="post" action="/sample/js.do" onsubmit="return showValidate('shotypeEtc1SampleForm', 'verror', '입력된 내용에 오류가 존재합니다.')">
				<table>
		...
		<tr style="background:white">
			<td>명시적인 지정 예제</td>
			<td>
				<form name="shotypeEtc2SampleForm" method="post" action="/sample/js.do" onsubmit="return showValidate('shotypeEtc2SampleForm', 'verror', '입력된 내용에 다음과 같은 오류가 존재합니다.')">
				<table>
				<tr>
				    <td align="right">
				        <span style="color:red">*</span>ID
