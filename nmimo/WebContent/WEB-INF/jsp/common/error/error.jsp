...
<!-- ollehWrap -->
	<div class="errorWrap">
		...
		<c:if test="${errorPrintYn=='Y'}">
		<p class="errorText"><strong>[Error Message]</strong></p>
		<p>${message}</p>
		<p>
			<textarea style="width:500px; height:200px;">${message} ${causeMessage} ${stacktrace}</textarea>
		</p>		
		</c:if>
