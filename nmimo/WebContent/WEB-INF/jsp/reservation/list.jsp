...
<script type="text/javascript">
	...
	$(function() {
		...
		//InnerList 호출
		pageLoadAjaxListInner("reservationListForm", "innerList", "/reservation/ajaxListInner.do"); 
...
// 	function doPostDetail(key){
// 		$("#bfacRegSeq").val(key);
// 		document.reviewReservationListForm.action = "/reservation/detail.do";
// 		document.reviewReservationListForm.submit();
// 	}
</script>
...
<!-- Search Area -->
<div class="search">
	<form id="reservationListForm" name="reservationListForm" method="post">
<!-- 		<input type="hidden" name="bfacRegSeq" id="bfacRegSeq" /> -->
		...
		<fieldset style="padding:10px; text-align:center">
			...
			<a href="#" onclick="javascript:doPostUrl('/review/reservationRegisterForm.do');" class="btn_red"><strong>사전예약신청</strong></a>
		</fieldset>
	</form>
</div>
