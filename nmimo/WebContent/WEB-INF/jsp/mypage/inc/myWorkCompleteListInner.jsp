...
<!-- Table Area // 나의작업>반려 리스트-->
<table summary="리스트" class="ListTable"  id="myWorkCompleteListTable" name="myWorkCompleteListTable">
	<caption>리스트</caption>
	<thead>
		<tr>
			<th style="width:100px">서비스구분</th>
			<th style="width:340px">제 목</th>
			<th style="width:200px">등록일시</th>
			<th style="width:100px">발송예정일</th>
			<th style="width:100px">요청건수</th>
	...
	<tbody>
		...
		<tr>
			...
			<td class="l"><a href="#" onclick="javascript:doPostDetail('${data.wrkId}','/myWork/completeListDetail.do');">${data.msgTitleNm}</a></td>
			<td>${data.cretDt}</td>
			<td>${data.rsrvDt}</td>
