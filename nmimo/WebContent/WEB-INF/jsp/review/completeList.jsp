...
<script type="text/javascript">
	...
	$(function() {
		...
		//InnerList 호출
		pageLoadAjaxListInner("completeListForm", "innerList", "/review/ajaxCompleteListInner.do"); 
		
		//tablesorter 적용 
// 		$("#completeListForm").tablesorter({widgets: ['zebra']});
...
<!-- Search Area -->
<div class="search">
	<form id="completeListForm" name="completeListForm" method="post">
