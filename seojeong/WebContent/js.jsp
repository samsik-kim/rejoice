...
._invalidMessages {font-size:9pt}
._invalidMessages li {padding:0px; margin:0px}
//-->
</style>
<c:if test="${not empty param.theme}"><c:set var="theme" scope="session" value="${param.theme}"/></c:if>
<c:if test="${empty theme}"><c:set var="theme" scope="session" value="south-street"/></c:if>
<link type="text/css" href="<c:url value="/js/jquery/ui/css/${theme}/jquery-ui-1.8.10.custom.css"/>" rel="stylesheet" />
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>JavaScript 샘플</title>
...
$(document).ready(function () {
	$(".btns").button();
	$("form[name=selectThemeForm] select[name=theme]").val("${theme}");
	//alert($("#dddd").next(".shom").length);
});
</script>
</head>
<body>
...
<tr>
	<td align="right">
	<form name="selectThemeForm">
		<table class="ui-widget" cellspacing="0" cellpadding="3">
		<tr>
			<td class="ui-widget-header ui-corner-left">
				테마선택
			</td>
...
<g:html>showValidate 펑션은  form 태그 내에 존재하는 각종 input 태그들 중에 v: 로 시작하는 속성값에 따라 검사하고,
...
<tr style="background:white">
	<td>소스</td>
	<td>
<g:html><form name="loginForm" method="post" action="js.jsp" onsubmit="return showValidate('loginForm', 'alert', '입력 오류가 있습니다.')">
        아이디 : <input type="text" name="id" v:required m:required="아이디를 입력하십시오."/>
        비밀번호 : <input type="password" name="passwd" v:required m:required="비밀번호를 입력하십시오."/>
...
<tr style="background:white">
	<td>예제</td>
	<td>
<form name="loginForm" method="post" action="js.jsp" onsubmit="return showValidate('loginForm', 'alert', '입력 오류가 있습니다.')">
        아이디 : <input type="text" name="id" v:required m:required="아이디를 입력하십시오."/>
        비밀번호 : <input type="password" name="passwd" v:required m:required="비밀번호를 입력하십시오."/>
	     <input type="submit" value="login"/>
</form>
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>소스</td>
			<td>
				<g:html><form name="requiredSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('requiredSampleForm', 'dialog', '입력 오류가 있습니다.')">
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="requiredSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('requiredSampleForm', 'dialog', '입력 오류가 있습니다.')">
				        아이디 : <input type="text" name="id"
				                               v:required m:required="아이디를 입력하십시오."/>
				        비밀번호 : <input type="password" name="passwd"
				                               v:required m:required="비밀번호를 입력하십시오."/>
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>소스</td>
			<td>
				<g:html><form name="mustcheckSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('mustcheckSampleForm', 'dialog', '입력오류를 확인하십시오.')">
				        성별
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="mustcheckSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('mustcheckSampleForm', 'dialog', '입력오류를 확인하십시오.')">
				        성별
				          <input type="radio" name="sex" value="m"
				                              v:mustcheck="1" m:mustcheck="성별을 선택하세요"/>남자
				          <input type="radio" name="sex" value="f"/>여자<br/>
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>소스</td>
			<td>
				<g:html><form name="mustnumSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('mustnumSampleForm', 'dialog', '다시 입력하세요.')">
				        나이
				          <input type="text" name="age"
				                             v:mustnum m:mustcheck="나이는 올바른 숫자로 입력하세요."/>세
					      <input type="submit" value="전송"/>
				</form></g:html>
			</td>
		</tr>
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="mustnumSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('mustnumSampleForm', 'dialog', '다시 입력하세요.')">
				        나이
				          <input type="text" name="age"
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>소스</td>
			<td>
				<g:html><form name="ncompareSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('ncompareSampleForm', 'dialog', '다시 입력하세요.')">
				        18금 통과 나이는?
				          <input type="text" name="age"
				    ...
				    고등학생 나이는?
				          <input type="text" name="hsage"
				                             ...
				                             v:ncompare2="<=,19" m:ncompare2="20세 이상은 너무 늙었습니다."/>세<br/>
				          <input type="button" value="Test" onclick="showValidate(this.form.hsage, 'default', '다시 입력하세요.')"/>
				    선호하는 연예인 나이는?
				          <input type="text" name="fromAge"
				                             v:mustnum m:mustnum="선호하는 연예인 나이는 숫자로 입력 해야 합니다."
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="ncompareSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('ncompareSampleForm', 'dialog', '다시 입력하세요.')">
				        18금 통과 나이는?
				          <input type="text" name="age"
				                             v:mustnum m:mustnum="18금 통과 나이는 숫자로 입력 해야 합니다."
				                             v:ncompare=">=,18" m:ncompare="18세 이상만 가능합니다."/>세<br/>
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>소스</td>
			<td>
				<g:html><form name="emailSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('emailSampleForm', 'dialog', '다시 입력하세요.')">
				        이메일
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="emailSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('emailSampleForm', 'dialog', '다시 입력하세요.')">
				        이메일
				          <input type="text" name="email" v:email m:email="이메일 주소가 올바르지 않습니다.."/>
					      <input type="submit" value="전송"/>
				</form>
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>소스</td>
			<td>
				<g:html><form name="dateSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('dateSampleForm', 'dialog', '다시 입력하세요.')">
				        시작일
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="dateSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('dateSampleForm', 'dialog', '다시 입력하세요.')">
				        시작일
				          <input type="text" name="startDate"
				                             v:required m:required="시작일을 입력하십시오."
				                             v:date m:date="시작일이 올바른 날짜 형식이 아닙니다."
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>소스</td>
			<td>
				<g:html><form name="regexpSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('regexpSampleForm', 'dialog', '다시 입력하세요.')">
				        ID
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="regexpSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('regexpSampleForm', 'dialog', '다시 입력하세요.')">
				        ID
				          <input type="text" name="id"
				                             v:required m:required="ID를 입력하세요."
				                             v:regexp="[a-zA-Z0-9]+" m:regexp="ID는 숫자및 영문만 지정 가능합니다."/>
	...
	<td>
		...
		<tr style="background:white">
			...
			<td>
				...
				<form name="dayTermLimitForm" method="post" action="js.jsp" onsubmit="return showValidate('dayTermLimitForm', 'dialog', '조회기간 오류')">
				        조회 기간 : 
				          <input type="text" name="startDate"
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>소스</td>
			<td>
				<g:html><form name="textLimitForm" method="post" action="js.jsp" onsubmit="return showValidate('textLimitForm', 'dialog', '입력제한 오류')">
                     <textarea name="note"
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="textLimitForm" method="post" action="js.jsp" onsubmit="return showValidate('textLimitForm', 'dialog', '입력제한 오류')">
					<textarea name="note"
						v:text8_limit="10" m:text8_limit="10바이트 까지만 입력 할 수 있습니다."
							onkeyup="$('#textBytes').text($.getByteLength(this));"></textarea>
					<span id="textBytes">0</span>Bytes<br/>
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>소스</td>
			<td>
				<g:html><form name="shotypeAlertSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('shotypeAlertSampleForm', 'alert', '잘못했을껄?')">
				<table>
				<tr>
				    <td align="right">
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="shotypeAlertSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('shotypeAlertSampleForm', 'alert', '잘못했을껄?')">
				<table>
				<tr>
				    <td align="right">
				        <span style="color:red">*</span>ID
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>소스</td>
			<td>
				<g:html><form name="shotypeDialogSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('shotypeDialogSampleForm', 'dialod', '오류다이얼로그제목')">
				<table>
				<tr>
				    <td align="right">
				        <span style="color:red">*</span>ID
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="shotypeDialogSampleForm" method="post" action="js.jsp" onsubmit="return showValidate('shotypeDialogSampleForm', 'dialog', '오류다이얼로그제목')">
				<table>
				<tr>
				    <td align="right">
				        <span style="color:red">*</span>ID
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>묵시적인 지정 소스</td>
			<td>
				<g:html><form name="shotypeEtc1SampleForm" method="post" action="js.jsp" onsubmit="return showValidate('shotypeEtc1SampleForm', 'verror', '입력된 내용에 오류가 존재합니다.')">
				<table>
		...
		<tr style="background:white">
			<td>묵시적인 지정 예제</td>
			<td>
				<form name="shotypeEtc1SampleForm" method="post" action="js.jsp" onsubmit="return showValidate('shotypeEtc1SampleForm', 'verror', '입력된 내용에 오류가 존재합니다.')">
				<table>
				<tr class="verror" name="/shotypeEtc1SampleForm" style="display:none">
					<td colspan="2" align="center">
						<span name="message" style="color:red;font-weight:bold;font-size:10pt"></span>
		...
		<tr style="background:white">
			<td>명시적인 지정 소스</td>
			<td>
				<g:html><form name="shotypeEtc2SampleForm" method="post" action="js.jsp" onsubmit="return showValidate('shotypeEtc2SampleForm', 'verror', '입력된 내용에 다음과 같은 오류가 존재합니다.')">
				<table>
				<tr>
				    <td align="right">
				        <span style="color:red">*</span>ID
				    ...
				    <td rowspan="5">
				    	<div class="verror" style="display:none" name="/shotypeEtc2SampleForm">
				    		...
				    		<ul type="1">
				    			<li class="verror" style="display:none" name="id/shotypeEtc2SampleForm"></li>
				    			<li class="verror" style="display:none" name="name/shotypeEtc2SampleForm"></li>
				    			<li class="verror" style="display:none" name="email/shotypeEtc2SampleForm"></li>
				    			<li class="verror" style="display:none" name="passwd/shotypeEtc2SampleForm"></li>
				    			<li class="verror" style="display:none" name="passwdConfirm/shotypeEtc2SampleForm"></li>
				    		</ul>
				    	</div>
				    </td>
				</tr>
		...
		<tr style="background:white">
			<td>명시적인 지정 예제</td>
			<td>
				<form name="shotypeEtc2SampleForm" method="post" action="js.jsp" onsubmit="return showValidate('shotypeEtc2SampleForm', 'verror', '입력된 내용에 다음과 같은 오류가 존재합니다.')">
				<table>
				<tr>
				    <td align="right">
				        <span style="color:red">*</span>ID
