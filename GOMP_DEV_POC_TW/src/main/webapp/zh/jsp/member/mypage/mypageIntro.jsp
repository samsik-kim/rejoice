...
function mypageCertification() {
	if(showValidate('frm', 'default', "<gm:string value='jsp.common.msg.title01'/>")){
		...
		$.post(env.contextPath + "/mypage/mypageCertificationAjax.omp", {"usrPw":usrPw, "param":"PROFILE"}, function(data) {
	...
	<div id="contents">
		...
		<form name="frm" method="post">
			<div class="txttype06">
				...
				<dl class="dlist03">
					<dt><label for="userid"><gm:html value='아이디'/></label></dt>
					<dd><input type="text" class="w128" value="${MEMBER_SESSION.mbrId}" name="userid" id="userid" readonly></dd>
				</dl>
