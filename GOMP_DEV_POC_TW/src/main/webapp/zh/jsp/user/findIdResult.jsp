...
<div id="contents_area">	  
	...
	<div id="contents">
		...
		<div class="utbox bgimg06">
			...
			您的帳號為<br />
			<span class="pbult08">帳號 : </span> <span class="txtcolor12">${resultId }</span></p>
		</div>
		<div class="btnarea mar_t30">
			...
			<a href="<c:url value='/login/findId.omp' />"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/common/btn_back.gif' />" alt="登入" /></a>
		</div>
