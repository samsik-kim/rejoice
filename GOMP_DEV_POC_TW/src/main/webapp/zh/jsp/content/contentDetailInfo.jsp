			...
			var options = {
					...
					success: function(responseText, status){
						...
						if(responseText.resultMessage.indexOf("SUCCESS") > -1) {
							...
							// 탭이동
							if (url.length > 0 ) {location.replace(url);}
							// 저장버튼
							else {
								alert("<gm:string value='jsp.content.common.msg.result.success'/>");
								location.replace(env.contextPath + "/content/contentDetailInfoView.omp?content.cid=" + '${content.cid}');
							}
						} else {
							// 저장 실패
			...
			<table summary="상품기본정보 입력">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="text" id="prodPrc" name="content.prodPrc" class="w150" value="<g:text value="${content.prodPrc}" format='R#,###,###,###'/>" onchange="javascript:checkPrice(this);" onkeyup="javascript:checkPrice(this);" onkeypress="javascript:checkPrice(this);" v:checkprodprc v:checkpayinfo m:checkprodprc="<gm:tagAttb value='jsp.content.contentDetailInfo.msg.prodPrc01'/>" m:checkpayinfo="<gm:tagAttb value='jsp.content.contentDetailInfo.msg.result05'/>" /> &nbsp;
							<span class="txt_90">원 (부가가치세 포함)</span> <br />
							<c:if test="${content.payMemberInfo == CONST.MEM_TYPE_DEV_NOPAY}" >
								<span class="txt_90">유료상품은 정산정보를 등록하신 회원에 한해 검증/판매가 가능 합니다.</span>&nbsp;
								<a href="javascript:gotoMemberPayInfo();"><img src="${pageContext.request.contextPath }/${ThreadSession.serviceLocale.language}/images/pm/btn_calculate.gif" alt="정산정보등록" /></a>
							</c:if>
						</td>
					</tr>
					<tr>
			...
			<table summary="상품설명정보 입력">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" id="prodDescSmmr" name="content.prodDescSmmr" value="${content.prodDescSmmr}" class="w410" onfocus="javascript:inputTextClear('SMMR');" v:checkprodproddescsmmr  m:checkprodproddescsmmr="<gm:tagAttb value='jsp.content.contentDetailInfo.msg.prodDescSmmr01'/>" v:text8_limit="100" m:text8_limit="<gm:tagAttb value='jsp.content.contentDetailInfo.msg.prodDescSmmr02'/>" /></td>		
					</tr>
					<tr>
						<th scope="row"><span>*</span> <label for="detailexp">상세 설명</label></th>
						<td>
							<textarea id="prodDescDtl" name="content.prodDescDtl" cols="1" rows="1" class="w410" onfocus="javascript:inputTextClear('DTL');"  v:checkprodproddescdtl  m:checkprodproddescdtl="<gm:tagAttb value='jsp.content.contentDetailInfo.msg.prodDescDtl01'/>" v:text8_limit="4000" m:text8_limit="<gm:tagAttb value='jsp.content.contentDetailInfo.msg.prodDescDtl02'/>">${content.prodDescDtl}</textarea>
						</td>
					</tr>
					<tr>
						...
						<td class="bgnone">
							<div class="fileinputs" id="divDescImgSelect"  style="display:${empty content.descImg.filePos?'box':'none'};" >
								<span><input type="file" class="inputFile" id="descImg" name="content.descImg.upload"  maxlength="1" onchange="javascript:setUploadFileNameCheck(this,'tempDescImgFile','jpg');" style="cursor: pointer;" onkeydown="this.blur();"></span>
								<div class="fakefile">
					...
					<tr>
						...
						<td class="bgnone lh210">
							<div class="fileinputs"  id="divPreviewImg1Select"  style="display:${empty content.previewImg1.filePos?'box;':'none;'}" >
								<span><input type="file" class="inputFile"  id="previewImg1" name="content.previewImg1.upload" maxlength="1" onchange="javascript:setUploadFileNameCheck(this, 'tempPreviewImg1File','jpg');" style="cursor: pointer;" onkeydown="this.blur();"  /></span>
								<div class="fakefile">
							...
							<div class="fileinputs"  id="divPreviewImg2Select"  style="display:${empty content.previewImg2.filePos?'box;':'none;'}" >
								<span><input type="file" class="inputFile"  id="previewImg2" name="content.previewImg2.upload" maxlength="1" onchange="javascript:setUploadFileNameCheck(this, 'tempPreviewImg2File','jpg');" style="cursor: pointer;" onkeydown="this.blur();" /></span>
								<div class="fakefile">
							...
							<div class="fileinputs"  id="divPreviewImg3Select" style="display:${empty content.previewImg3.filePos?'box;':'none;'}" >
								<span><input type="file" class="inputFile"  id="previewImg3" name="content.previewImg3.upload" maxlength="1" onchange="javascript:setUploadFileNameCheck(this, 'tempPreviewImg3File','jpg');" style="cursor: pointer;" onkeydown="this.blur();" /></span>
								<div class="fakefile">
							...
							<div class="fileinputs"  id="divPreviewImg4Select" style="display:${empty content.previewImg4.filePos?'box;':'none;'}" >
								<span><input type="file" class="inputFile"  id="previewImg4" name="content.previewImg4.upload" maxlength="1" onchange="javascript:setUploadFileNameCheck(this, 'tempPreviewImg4File','jpg');" style="cursor: pointer;" onkeydown="this.blur();"/></span>
								<div class="fakefile">
