...
<div id="contents_area">
	...
	<form id="inputForm" name="inputForm"  method="post" enctype="multipart/form-data" action="<c:url value="/mypage/mypageCalculateInfoInsert.omp"/>">
			...
			<table summary="정산정보 입력">
				...
				<tbody>
					<tr>
						...
						<c:if test="${calculateInfo.mbrClsCd eq 'US000102'}">
						<th scope="row"><span>*</span> <gm:html value='회사증명사본'/></th>
						</c:if>
						<c:if test="${calculateInfo.mbrClsCd eq 'US000103'}">
					...
					<tr>
						...
						<a href="#" id="searchBank"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/mp/btn_bankcode.gif'/>" alt="은행코드찾기" /></a>&nbsp;&nbsp;
					...
					<tr>
						<th scope="row"><span>*</span> <label for="bankinfo"><gm:html value='은행정보'/></label></th>
						<td><input type="text" id="bankinfo" name="calculateInfo.bankCd" class="w180" readonly="readonly" v:required='trim' m:required="<gm:tagAttb value='jsp.member.mypage.msg.bk01'/>"/>&nbsp;
						<a href="#" id="searchBank"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/mp/btn_bankcode.gif'/>" alt="은행코드찾기" id="searchBank" /></a>&nbsp;&nbsp;
						<input type="text" id="bankinfo1" name="calculateInfo.bankNm" class="w180" readonly="readonly"/></td>
					</tr>
					<tr>
						<th scope="row"><span>*</span> <label for="accountnum"><gm:html value='계좌정보'/></label></th>
		...
		<div class="guideinfo">
			<p class="pbult01"><gm:html value='정산정보 입력 안내'/></p>
		...
		<div class="btnarea mar_t30">
			...
			<a href="javascript:TotalFileSizeLimit();"><img alt="취소" src="<c:url value="/${ThreadSession.serviceLocale.language}/images/common/btn_cancel.gif"/>"></a>
		</div>
