...
<div id="contents_area">
	...
	<div id="contents">
		...
		<div class="mpbox bgimg08">
			...
			<span class="pbult08"><gm:html value='변경된 이메일 주소'/> :</span> <span class="txtcolor12"><g:html  value='${profileInfo.emailAddr}' /></span></p>
		</div>
		<div class="btnarea mar_t30">
			<a href="#"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/common/btn_confirm.gif'/>" alt="확인"  onclick="javascript:gotoPage('MAIN');"/></a>
		</div>
