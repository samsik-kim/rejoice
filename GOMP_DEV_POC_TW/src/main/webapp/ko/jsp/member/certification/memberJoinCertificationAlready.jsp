...
<div id="contents_area" class="ut_area">
	...
	<div id="utcontents">
		...
		<div class="utbox bgimg03">
			...
			<p class="pad_b7">
				회원님께서는 이미 이메일 인증을 완료하셨습니다.<br />가입하신 아이디로 로그인 후 개발자센터를 이용해주시기 바랍니다.
			</p>
		</div>
		<div class="btnarea mar_t30">
			<a href="#"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/common/btn_main.gif'/>" alt="메인" onclick="javascript:gotoPage('MAIN');"/></a>
