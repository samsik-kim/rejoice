...
public class RandomString {
    ...
    /**
     * Default ALL 
     * @param len 		: randomString Length Setting
    ...
    /**
     * @param len 		: randomString Length Setting
     * @param type 		: randomString Type Setting
     * @return String 	: randomString
     */
    ...
    public static void main(String[] args) {
    	for (int i=0; i<100; i++) {
			...
			System.out.println("        Only number : " + RandomString.getString(10, RandomString.TYPE_NUMBER));
			...
			System.out.println("lower case + Number : " + RandomString.getString(10, RandomString.TYPE_NUMBER + RandomString.TYPE_LOWER_ALPHA));
			System.out.println("upper case + Number : " + RandomString.getString(10, RandomString.TYPE_NUMBER + RandomString.TYPE_UPPER_ALPHA));
