...
<script type="text/javascript">
	...
	var funcAccountList	= function()	{
		...
		<p class="fl mt25"><a class="btn" href="javascript:deleteAccount('${adMgr.mgrId}');"><span>삭제</span></a></p>
		<p class="btn_wrap text_r mt25"><a class="btn" id="btnSubmit" href="javascript:funcProcessAdMgr();"><span>저장</span></a> <a class="btn" href="javascript:funcAccountList();"><span>목록</span></a></p>
