...
<body >
			...
			<table class="tabletype01">
				...
				<tr>
					<th colspan="2">조정액</th>
					<td>
						 <p class="fr pt05"><g:html value="${accounts.adjReasonInsBy}"/></p> <font id="adjAmtText" ><g:text value="${accounts.adjAmt}" format="###,###,###,###.##" /></font> <a href="#" class="btn_s" id="adjPopUp"><span>자세히보기</span></a> 
