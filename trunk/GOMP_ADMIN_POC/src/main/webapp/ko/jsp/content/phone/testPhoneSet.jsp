				...
				<table id="testPhonSet" name="testPhonSet" summary="테스트단말 설정">
					...
					<c:forEach items="${testPhSetList}" var="item" varStatus="status">
						<tr id="trPh${status.index+1}">
							...
							<td class="td01">
								<input type="text" id="${item.tmpSeq}" name="testcel" value="<gm:html value="${item.macAddr}"/>" class="w520"  onfocus="javascript:inputTextClear(this);" v:showcustomvalidate m:showcustomvalidate="<gm:tagAttb value='jsp.content.phone.testPhoneSet.text.01'/>" v:showcustomvalidatenull m:showcustomvalidatenull="<gm:tagAttb value='jsp.content.phone.testPhoneSet.btn.01'/>"/>
