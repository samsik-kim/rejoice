...
<div id="popup_area_440">
	<h1 class="mt25">발급대상 검색</h1>
	<table class="pop_tabletype01">
		<colgroup><col width="30%;"><col width="70%;"></colgroup>
		<tr>
			<th>회원검색</th>
			<td>ID <input type="text" id="searchText" name="sub.searchText" value="${sub.searchText }"/><a class="btn" href="#" id="searchBtn" ><strong>검색</strong></a></td>
		</tr>
	</table>
	<c:if test='${sub.firstCheck == "Y"}'>
		<div class="pop_btn" >
			<a class="btn" href="#" id="exitBtn"><strong>닫기</strong></a>
		</div>
	</c:if>
		...
		<c:if test="${giftCardlist != null}">
			<table class="pop_tabletype02 mt10">
				...
				<c:forEach items="${giftCardlist }" var="giftcard">
					<tr>
						<td>${giftcard.mbrId } &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						 <a class="btn" href="#" onclick="javascript:setValue('${giftcard.mbrId }');" align="right"><strong>선택</strong></a></td>
					</tr>
				</c:forEach>
			</table>
			<div class="pop_btn" >
