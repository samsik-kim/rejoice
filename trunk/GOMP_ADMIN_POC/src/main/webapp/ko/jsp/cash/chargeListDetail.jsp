...
<body>
	<div id="location">
		Home &gt; 상품관리 &gt; 캐쉬관리 &gt <strong>충전내역</strong> 
	</div><!-- //location -->

	<h1 class="fl pr10">충전내역</h1>
	...
	<p class="fl mt35">>${sub.prchsDt} &nbsp;충전 상세 현황</p>			
	...
	<table class="tabletype02">
		...
		<tr>
			<th rowspan="2">번호</th>
			<th rowspan="2">ID(이름)</th>
			<th colspan="2">충천수단</th>
			<th rowspan="2">T store Cash 거래량</th>
		...
		<tr>
			...
			<td><c:choose><c:when test="${charge.applyCancel eq 'Y'}">
					<a class="btn_s" id="cancelBtncharge.rnum" name="cancelBtn${charge.rnum }" href="#" onclick="onCancle('${charge.mbrId }','${charge.prchsDt }','${charge.rnum }');"/><span>취소</span></a></td>
