	...
	<form name="registForeigner" id="registForeigner" method="post">		
		...
		<div class="utbox">
			...
			<p class="pbult02">
				...
				<input type="text" id="psRegNo" name="member.psRegNo" class="w168" 
				v:required='trim' m:required="<gm:tagAttb value='jsp.member.regist.registForeigner.msg.pt02'/>"
				v:text8_limit="20" m:text8_limit="<gm:tagAttb value='jsp.member.regist.registForeigner.msg.pt03'/>"/>
			</p>
		</div>
