				...
				<table summary="회원기본정보 입력 항목입니다">
					...
					<tbody>
						<tr>
							...
							<input type="hidden" value="<g:tagAttb value="${member.mbrNm}"/>" name="member.compNm" id="mbrNm"/>
						</tr>   
						<tr>
						...
						<tr> 
							...
							<td><input type="password" id="mbrPw" name="member.mbrPw" class="w180"
								...
								v:reqexpwwith m:reqexpwwith="<gm:tagAttb value='jsp.member.join.msg.pw02'/>"/><span class="txtcolor01"> &nbsp;* 6-16자의 영대소문자, 숫자, 특수문자만 사용, 공백입력 불가</span></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" id="zipCd" name="member.zipCd" class="w180" maxlength="3" onkeyup="checkNumber(this)"
								v:text8_limit="3" m:text8_limit="<gm:tagAttb value='jsp.member.join.msg.zp01'/>" 
								v:regexp="[\d]+" m:regexp="<gm:tagAttb value='jsp.member.join.msg.zp02'/>"/><span class="txtcolor01"> &nbsp;* “ㅡ” 을 생략하고 우편번호 5자리를 숫자로만 입력해 주세요.</span></td><!-- text추가 -->	
							</td>
						</tr>
						<tr>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<input type="text" class="w109" onkeyup="checkNumber(this)"
								...
								<input type="hidden" name="member.opTelNo" id="opTelNo"/><span class="txtcolor01"> &nbsp;* “ㅡ” 을 생략하고 숫자로만 입력해 주세요.</span>
							</td>
						</tr>
						<tr>
							<th scope="row" class="tit01"><span>*</span> <label for="moblenum">휴대폰 번호</label></th>
							<td class="bgnone">
								<input type="text" id="moblenum" name="member.opHpNo" class="w180" onkeyup="checkNumber(this)"
								...
								<input type="hidden" value="<g:tagAttb value='${member.mbrClsCd}'/>" name="member.mbrClsCd" id="mbrClsCd"/><span class="txtcolor01"> &nbsp;* “ㅡ” 을 생략하고 숫자로만 입력해 주세요.</span></td><!-- text추가 -->
							</td>
						</tr>
					</tbody>
				</table>
