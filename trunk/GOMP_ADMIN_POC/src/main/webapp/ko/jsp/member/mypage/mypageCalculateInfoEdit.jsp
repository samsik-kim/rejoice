...
<div id="contents_area">
	...
	<form id="inputForm" name="inputForm"  method="post" enctype="multipart/form-data" action="<c:url value="/mypage/ajaxMypageCalculateInfoInsert.omp"/>">
		...
		<c:if test="${calculateInfo.mbrClsCd eq 'US000101'}">
			<table summary="정산정보 입력">
				...
				<!-- New -->
					...
					<tr>
						<th scope="row"><span>*</span> <label for="savename">예금주</th>
					...
					<tr>
						<th scope="row" class="tit01"><span>*</span> <label for="bankbook">통장사본</label></th>
						<td class="bgnone">
		...
		<div class="guideinfo">
			<p class="pbult04"> &middot; 정산정보 수정 시 운영자의 검토 후 승인 완료된 후에 수정된 정보로 판매정산 처리가 되어집니다.</p>
			<p class="pad_l15"> &middot; 계좌정보 변경은 매월 1일~ 20일 이전에 해주셔야 변경하신 계좌로 송금이 됩니다.</p>
		</div>
