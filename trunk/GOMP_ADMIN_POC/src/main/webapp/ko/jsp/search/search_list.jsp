...
<div id="location">
				Home &gt; 컨텐츠관리 &gt; 검색어관리 &gt; <strong>검색어관리</strong> 
			</div><!-- //location -->
 
			<h1 class="fl pr10">검색어관리</h1>
			<p>검색어를 관리 할 수 있다..</p>
			<table class="tabletype01">
				...
				<tr>
					...
					<td class="text_c" >
						<a class="btn" href="javascript:selectSearchList();"><strong>검색</strong></a>
					</td>
				</tr>
			</table>
			<p class="fl mt20 mb05"><a class="btn_s" href="javascript:searchIns()"><span>검색어 등록</span></a></p>
			<p class="fr mt25">검색어수 : <g:html value="${searchCnt }" /> 건</p>
				...
				<c:when test="${searchCnt > 0}">
					<c:forEach items="${searchList}" var="item" varStatus="status">
						<tr>
							...
							<td class="align_td"><a class="btn_s" href="javascript:modNm(${item.searchIdx},'<g:string value='${item.searchNm}'/>');"><span>수정</span></a> <a class="btn_s" href="javascript:btnDel(${item.searchIdx});"><span>삭제</span></a></td>
							<td class="align_td">
			...
			<p class="fl mt05"><a class="btn_s" href="javascript:func_deleteSearch();"><span>선택삭제</span></a></p>
