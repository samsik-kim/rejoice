...
<div id="contents_area">
	...
	<div id="ctitle_area">
		...
		<h3><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/ip/ip_title02.gif' />" alt="find password" /></h3>
	</div>
	...
	<div id="contents">
		...
		<form id="frm" name="frm" action="" method="post"" onsubmit="return showValidate('frm', 'default', '<gm:string value="jsp.user.common.msg.errTitle"/>');">
			<div class="utbox mar_b30">	
				...
				v:regexp="[a-z0-9]{8,13}" m:regexp="<gm:tagAttb value='jsp.user.findPw.msg.id02'/>" value="<g:tagAttb value="${userId }"/>" onkeypress="javascript:keypressEvent(event);"/>
