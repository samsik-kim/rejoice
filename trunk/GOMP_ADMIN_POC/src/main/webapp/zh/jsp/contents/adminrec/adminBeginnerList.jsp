...
<script language='javascript'>
	...
	function funcUpdateAdminRecommend() {
		...
		if(chkLen > 0){
			...
			document.searchForm.action = './updateAdminBeginnerList.omp';
			document.searchForm.submit();
			}
		} else {
	...
	function funcDeleteAdminRecommend() {
		...
		document.searchForm.action='./deleteAdminBeginnerList.omp?selectedProdId='+selectedProdId;
		document.searchForm.submit();
...
*/
	...
	$(document).ready( function()	{
		...
		$( "#checkAll" ).click( function()	{
			...
			<div id="location">
				首頁 &gt; 內容管理中心 &gt; 必選產品管理 &gt; <strong>必選產品管理</strong>
			</div><!-- //location -->
			<!-- 2011-03-18 -->
			<div class="overflow_h">
				<h1 class="fl pr10">必選產品管理</h1>
				<p>管理者可編輯為新手推薦的必選產品.</p>
			</div>	
