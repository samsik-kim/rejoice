...
<script language="javascript">
	...
	<div id="popup_area_440">
		<p class="mb10"> 輸入欲使用之帳號後點選[確認重複與否]鍵。</p>
        <div class="box03">
        	<p class="mt20"><label for="#"><strong>帳號</strong></label>
            ...
            <a class="btn_s" href="javascript:funcPopCheckAccount();"><strong>確認重複與否</strong></a></p>
	...
	<s:else>
		...
		<div class="pop_btn" >
			<a class="btn_s" href="javascript:funcClose('${resultId}');"><strong>確定</strong></a>
		</div>
	</div>
	</s:form>
