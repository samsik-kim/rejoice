...
<script type="text/javascript">
	...
	var funcUpdateAdMgrauth = function() {
		...
		//alert("SELECTED AUTH : " + document.frm.checkMenuId.value);
...
<body class="popup" onload="">
	...
	<div id="popup_area_440">
   		<div class="box02">
        	<p>權限設定之帳號 : <span class="point2">${selectedAccount}</span></p>
        </div>
        <br />
...
<!--
            ...
            <li><a href="#"><img src="${pageContext.request.contextPath }/${ThreadSession.serviceLocale.language}/images/icon_m.gif" alt="" /></a><input type="checkbox" /> 상품정산관리 (1 checked)</li>
            	<ul class="pl30">
                    ...
                    <li><a href="#"><img src="${pageContext.request.contextPath }/${ThreadSession.serviceLocale.language}/images/icon_p.gif" alt="" /></a><input type="checkbox" /> WhoopyCash 관리</li>
                </ul>
...
-->
		...
		<div class="pop_btn" >
			<a class="btn_s" href="javascript:funcUpdateAdMgrauth();"><strong>儲存</strong></a>
