...
<div id="popup_area_440">
		<h1>附加關鍵字</h1>
		<p class="mt20"><label><strong>關鍵字</strong></label>
		...
		<div class="pop_btn" >
			<a class="btn_s" href="javascript:insertSearch();"><strong>儲存</strong></a>
			<a class="btn_s" href="javascript:closePop();"><strong>關閉</strong></a>
		</div>
	</div>
</s:form>	
</body>