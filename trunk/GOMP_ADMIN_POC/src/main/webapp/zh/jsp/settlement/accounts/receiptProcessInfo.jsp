...
<body>
			...
			<table class="tabletype01">
				...
				<tr>
					...
					<td>
						...
						<c:if test="${ accounts.adjAmt > 0}"> <!-- 조정액이 존재하면 팝업-->
						 <a href="#" class="btn_s" id="adjPopUp"><span>詳細內容</span></a><p class="fr pt05"><gc:html code="${accounts.adjReasonInsBy}"/></p>
						</c:if>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<textarea cols="67" rows="8" id="accountsSS.rmtReason" name="accountsSS.rmtReqReason" disabled><g:tagAttb value="${accounts.rmtReqReason}" /></textarea>
					</td>
				</tr>
			</table>
			</s:form>
