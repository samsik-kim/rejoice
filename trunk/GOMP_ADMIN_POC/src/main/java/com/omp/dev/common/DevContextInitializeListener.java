...
//			spir.setIncLink("<a href='${link}' title='go Page ${no}'>+</a>");
			...
			spir.setNextLink("");
			spir.setDecLink("<a href='${link}' class='pre' title='go Page ${no}'><img src='" + contextPath + "/images/common/btn_pre.gif'/></a>&nbsp;");
			spir.setIncLink("&nbsp;<a href='${link}' class='next' title='go Page ${no}'><img src='" + contextPath + "/images/common/btn_next.gif'/></a>");
