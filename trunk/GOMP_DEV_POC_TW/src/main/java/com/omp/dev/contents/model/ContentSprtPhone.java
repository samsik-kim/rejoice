...
public class ContentSprtPhone {

	private String scid;
	private int	sprtPhoneSeq;
	 ...
	 */
	public void setSprtPhoneSeq(int sprtPhoneSeq) {
	...
	/**
	 * @param lcdSize the lcdSize to set
	 */
