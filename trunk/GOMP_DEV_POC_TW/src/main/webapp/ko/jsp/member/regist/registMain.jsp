...
$(document).ready( function() {
	$("#person").click(function() {
		...
		$("#regist").attr('action', env.contextPath + '/member/registPerson.omp');
		$("#regist").submit();
	});
	$("#company").click(function() {
		$('#mbrClsCd').attr('value', '${CONST.MEM_CLS_BUSINESS}');
		$("#regist").attr('action', env.contextPath + '/member/registCompany.omp');
		$("#regist").submit();
	});
	$("#foreigner").click(function() {
		$('#mbrClsCd').attr('value', '${CONST.MEM_CLS_FOREIGNER}');
		$("#regist").attr('action', env.contextPath + '/member/registForeigner.omp');
		$("#regist").submit();
	});
});
</script>