...
<input type="hidden" id="noticeId" name="notice.noticeId" value="${notice.noticeId}"/>
	<table class="list_table">
		...
		<tr>
			...
			<th><img src="${pageContext.request.contextPath }/${ThreadSession.serviceLocale.language}/images/pw/th_snum.gif" alt="조회수" /></th>
			<th class="bo_r bg_f0"><img src="${pageContext.request.contextPath }/${ThreadSession.serviceLocale.language}/images/pw/th_wdate.gif" alt="작성일" /></th>
		</tr>
		<c:choose>
