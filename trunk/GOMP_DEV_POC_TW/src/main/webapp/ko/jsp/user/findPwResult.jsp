...
<div id="contents_area">
	...
	<div id="contents">
		...
		<div class="ipbox bgimg07">
			...
			임시비밀번호가 입력하신 <span class="txtcolor07">${email }</span>의 주소로 발송되었습니다.<br />
		...
		<div class="btnarea mar_t30">
			...
			<a href="<c:url value='/login/findPw.omp'/>"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/common/btn_back.gif'/>" alt="뒤로" /></a>
		</div>
