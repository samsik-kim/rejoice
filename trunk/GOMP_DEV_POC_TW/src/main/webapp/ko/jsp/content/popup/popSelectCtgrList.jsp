...
<div class="layerwrap">
	...
	<div id="pop_area01">
		<h2><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/pop/pm_title_03.gif' />" alt="상품분류 선택" /></h2>
		<p class="pop_txt3">상품의 분류를 선택해 주세요. (1개만 선택 가능)</p>
		...
		<div class="pop_btn">
			<a href="javascript:choiceContentCtgr();"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/pop/btn_confirm.gif' />" alt="전체선택" /></a>
			<a href="javascript:closePopupLayer('popSelectCtgrList');"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/pop/btn_cancle.gif' />" alt="취소" /></a>
		</div>
		<p class="pop_close"><a href="javascript:closePopupLayer('popSelectCtgrList');"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/pop/btn_close.gif' />" alt="닫기" /></a></p>
