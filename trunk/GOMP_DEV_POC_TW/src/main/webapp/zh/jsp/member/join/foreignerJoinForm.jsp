			...
			<form id="foreignerForm" name="foreignerForm" method="post">
				<table summary="基本資料">
					...
					<tbody>   
						...
						<tr>
							<th scope="row"><span>*</span> <label for="phonenum">聯絡電話</label></th>
							...
							<span class="txtcolor01">&nbsp;* 請加上國碼和區碼!</span></td>
						</tr>
						<tr>
							...
							<td>
								...
								v:text8_limit="20" m:text8_limit="<gm:tagAttb value='jsp.member.join.msg.hp02'/>"
							 	v:required='trim' m:required="<gm:tagAttb value='jsp.member.join.msg.hp01'/>" /> <span class="txtcolor01">&nbsp;* 請加上國碼和區碼!</span></td>
							 </td>
						</tr>
						<tr>
