...
<div id="contents_area">
	...
	<form id="frmCompInput" name="frmCompInput" method="post">
		...
		<div class="mpbox bgimg12">
			<div class="txttype09">
				<dl class="dlist04">
					<dt><label for="businame"><gm:html value='회사명'/></label></dt>
					<dd>
						<input type="text" class="w227" name="transferInfo.compNm" id="businame" v:required='trim' m:required="jsp.member.regist.registCompany.msg.cmnm01"
				...
				<dl class="dlist04 mar_b5">
					<dt><label for="comnum"><gm:html value='통일번호'/></label></dt>
					<dd>
						<input type="text" class="w227" name="transferInfo.psRegNo" id="comnum" v:required='trim' m:required="jsp.member.regist.registCompany.msg.cmno02" 
