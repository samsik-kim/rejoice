...
<table width="259px" height="574px" border="0" cellpadding="0" cellspacing="0" id="iphoneTable">
	...
	<tr>
		...
		<td class="hp_mid_bg" style="background-image:url(/resource/iphone/images/iphone_bg_03.gif);" width="219px" height="198px">
			<!--메시지입력-->
			<textarea name="msg" style="width:209px; height:170px;border:none;padding:5px 0 5px 0;display:none;" onKeyUp="chkBytes();"></textarea>
			<textarea name="msg_test" id="msg_test" style="width:209px; height:170px;border:none;padding:5px 0 5px 0;display:none;"></textarea>

			<iframe id="textWindow" name="textWindow" marginWidth="0" marginHeight="0" frameBorder="0" width="209px" height="160px" style="visibility:visible;overflow-y:auto;overflow-x:hidden;" onload="iframeOn();"></iframe>
			...
			<table width="219px" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td align="center" style="padding:5px 0 7px 0;">
						...
						<img src="/resource/iphone/images/ico_param.gif" align="absmiddle" border="0" style="cursor:hand;" onclick="stringAdd();" ></td>
				</tr>
				<tr>
					<td align="center">
						<!--컬러아이콘-->
