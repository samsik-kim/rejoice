...
<!-- Table Area // 검토>완료 -->
<table summary="리스트" class="ListTable"  id="reviewCompleteListTable" name="reviewCompleteListTable">
	<caption>리스트</caption>
	<thead>
		<tr>
	...
	<tbody>
		...
		<tr>
			...
			<td class="l"><a href="#" onclick="javascript:doPostDetail('${data.wrkId}','/review/completeListDetail.do');">${data.msgTitleNm}</a></td>
			<td>${data.cretDt}</td>
			<td>${data.rsrvDt}</td>
