...
<!-- Table Area // 사전예약 -->
<table id="reviewReservationListTable" name="reviewReservationListTable" summary="리스트" class="ListTable">
	<caption>리스트</caption>
	<thead>
		<tr>
	...
	<tbody>
		...
		<tr>
			<td class="l"><a href="#" onclick="javascript:doPostDetail('${data.bfacRegSeq }','/review/reservationDetail.do');">${data.userNm}</a></td>
		    <td>${data.cretrId}</td>
			<td>${data.cretDt}</td>
