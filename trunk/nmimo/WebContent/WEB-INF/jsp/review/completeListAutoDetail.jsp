...
<link rel="stylesheet" type="text/css" href="/resource/ets/iphone/css/set.css">

<script type="text/javascript" src="/resource/ets/iphone/js/iphone.js"></script>
...
<form action="#" method="post" class="sbox">
	<fieldset>
		...
		<label for="">사용자아이디</label> <input type="text" id="" style="width:100px;" />
		<label for="">사용자명</label> <input type="text" id="" style="width:100px;" />
		<label for="">부서명</label> <input type="text" id="" style="width:150px;" />
		<label for="">발송승인자</label> <input type="text" id="" style="width:100px;" />
	</fieldset>
</form>
...
<table width="259px" height="574px" border="0" cellpadding="0" cellspacing="0" id="iphoneTable">
	<tr>
		<td colspan="3" class="hp_top_bg" style="background-image:url(/resource/ets/iphone/images/iphone_bg_01.gif);" width="259px" height="133px">
				...
				<tr>
					...
					<td>
						<a href="#" onclick="javascript:pop('/crm/myBoxPop.do','crmMyBoxPop','800','300');">
							<img src="/resource/ets/iphone/images/ico_my_space.gif" alt="개인보관함" border="0">
						</a>
					</td>
				</tr>
			</table>
	...
	<tr>
		<td>
			<img src="/resource/ets/iphone/images/iphone_bg_02.gif" width="21px" height="198px" alt=""></td>
		<td class="hp_mid_bg" style="background-image:url(/resource/ets/iphone/images/iphone_bg_03.gif);" width="219px" height="198px">
			<!--메시지입력-->
		...
		<td>
			<img src="/resource/ets/iphone/images/iphone_bg_04.gif" width="19px" height="198px" alt="">
		</td>
	</tr>
	<tr>
		<td colspan="3" class="hp_bom_bg" style="background-image:url(/resource/ets/iphone/images/iphone_bg_05.gif); " width="259px" height="243px">
			...
			<table width="219px" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td align="center" style="padding:5px 0 7px 0;">
						<img src="/resource/ets/iphone/images/ico_img_add.gif" align="absmiddle" border="0" style="cursor:hand;" onclick="javascript:pop('/crm/addImgPop.do','crmAddImgPop','800','300');">
						<img src="/resource/ets/iphone/images/ico_mov_add.gif" align="absmiddle" border="0" style="cursor:hand;" onclick="javascript:pop('/crm/addMovPop.do','crmAddMovPop','800','300');">
						<img src="/resource/ets/iphone/images/ico_param.gif" align="absmiddle" border="0" style="cursor:hand;" onclick="stringAdd(iphoneForm);" ></td>
				</tr>
				<tr>
					<td align="center">
						<!--컬러아이콘-->
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','black');">
									<img src="/resource/ets/iphone/images/common_color_01.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','gray');">
									<img src="/resource/ets/iphone/images/common_color_02.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','silver');">
									<img src="/resource/ets/iphone/images/common_color_03.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','white');">
									<img src="/resource/ets/iphone/images/common_color_04.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','maroon');">
									<img src="/resource/ets/iphone/images/common_color_05.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','red');">
									<img src="/resource/ets/iphone/images/common_color_06.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','purple');">
									<img src="/resource/ets/iphone/images/common_color_07.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','Fuchsia');">
									<img src="/resource/ets/iphone/images/common_color_08.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','green');">
									<img src="/resource/ets/iphone/images/common_color_09.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','lime');">
									<img src="/resource/ets/iphone/images/common_color_10.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','olive');">
									<img src="/resource/ets/iphone/images/common_color_11.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','yellow');">
									<img src="/resource/ets/iphone/images/common_color_12.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','navy');">
									<img src="/resource/ets/iphone/images/common_color_13.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','blue');">
									<img src="/resource/ets/iphone/images/common_color_14.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','teal');">
									<img src="/resource/ets/iphone/images/common_color_15.gif" width="11px" height="12px"></td>
								<td width="3"></td>
								<td class="msg_font_color" onclick="changeCommand('ForeColor','aqua');">
									<img src="/resource/ets/iphone/images/common_color_16.gif" width="11px" height="12px"></td>
							</tr>
						</table>
						<!--컬러아이콘-->
					</td>
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td valign="top" style="padding:2px 2px 0 0;">
									<img src="/resource/ets/iphone/images/ico_arrow.gif" align="absmiddle" border="0"></td>
...
<form action="#" method="" style="clear:both">
  	<fieldset style="padding-top:10px;">
	<legend class="hidden">입력</legend>
	  <table summary="리스트" class="WriteTable">
		  <caption>리스트</caption>
		  <tbody>
			  <tr>
				  <th class="c" scope="row">예약일 및 발송 대상 고객 파일 첨부</th>
			  </tr>
                    <tr>
                        <td class="l" scope="row">
                        <input type="text" id="" class="iType" style="width:300px;" />
                        <a href="#" class="btn_sml"><span>파일찾기</span></a>
                        <input type="text" id="" class="iType" style="width:80px; margin-left:10px" />
                        <a href="#"><img src="../../resource/images/icon_calendar.gif" /></a>
                        <select id="" class="sType" style="width:60px;">
                        <option value="">::시간::</option>
                            <option value=""></option>
                        </select>
                        <span class="red" style=" padding-left:10px"><a href="#" class="btn_help"><span>도움말</span></a>
                        총 3건</span>
                        </td>
			      </tr>
                    <tr>
                        <td class="l" scope="row">
                        대상파일 다운 : <a href="#">20121106162715_admin_new.txt </a>
                        </td>
		      </tr>
		  </tbody>
	  </table>
