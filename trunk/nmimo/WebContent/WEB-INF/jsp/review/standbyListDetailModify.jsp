...
<!-- Help -->
<div class="help">
	사용량통보 및 고객상태변경시 자동으로 발송되는 메시지 작성 화면입니다.<br />
...
<p class="btnC" style="position:relative;top:-10px">
    <a href="javascript:Common.centerPopupWindow('/myPage/popup/previewPop.do','window',{width:610,height:620,scrollBars:'no'});" class="btn_red"><strong>시험발송</strong></a>
	<a href="#" class="btn_red"><strong>승 인</strong></a>
    <a href="javascript:Common.centerPopupWindow('/review/popup/standbyListDetailReturnJobPop.do','window',{width:420,height:340,scrollBars:'no'});" class="btn_red"><strong>반 려</strong></a>
    <a href="/myWork/standbyList.do" class="btn_red"><strong>목 록</strong></a>
</p>