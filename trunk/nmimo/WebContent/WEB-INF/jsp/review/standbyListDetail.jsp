...
$(document).ready(function() { 
	...
	textWindow.document.write("${viewInfo.msgSbst}");
...
<div style="clear:both">
	...
	<table summary="리스트" class="WriteTable">
		...
		<tbody>
			...
			<tr>
				<td class="l" scope="row">대상파일 다운 : <a href="#">${viewInfo.tgtrFileNm}</a></td>
			</tr>
	</table>
	</fieldset>
</div>
...
<p class="btnC" style="position:relative;top:-10px">
	...
	<a href="#" onclick="history.back();" class="btn_red"><strong>목 록</strong></a>
