...
<link type="text/css" href="/resource/jquery-ui-1.10.2.custom/css/smoothness/jquery-ui-1.10.2.custom.min.css" rel="stylesheet" />	
<script type="text/javascript" src="/resource/jquery-ui-1.10.2.custom/js/jquery-1.9.1.js"></script>
<script type="text/javascript" src="/resource/jquery-ui-1.10.2.custom/js/jquery-ui-1.10.2.custom.js"></script>
<script type="text/javascript" src="/resource/jquery-ui-1.10.2.custom/js/jquery-ui-1.10.2.custom.min.js"></script>
...
<script type="text/javascript">
	...
	//PSSO연동 로그인
	function pssoLogin(){
		document.all.pssoForm.action = "https://psso.show.co.kr/logon/logon.asp";
		document.all.pssoForm.submit();
	}

	//PSSO연동 쿠키체크
	function pssoChk(){
		document.all.pssoForm.action = "https://psso.show.co.kr/Logon/CookieCheck.asp";
		document.all.pssoForm.submit();
	}
	...
	function pssoPop(){
		...
		window.open('','crmList','');
		document.all.pssoForm.action = "/crm/campaign.do";
		document.all.pssoForm.target = "crmList";
		document.all.pssoForm.submit();
	}
...
<a href="#" onClick="pssoLogin();"><p align="left" style="font-size:10pt;font-weight:bold">1.CRM제공 PSSO로그인</p></a><br>
<!-- <a href="#" onClick="pssoChk();"><p align="left" style="font-size:10pt;font-weight:bold">2.CRM제공 Cookie체크</p></a><br> -->
<a href="#" onClick="pssoPop();"><p align="left" style="font-size:10pt;font-weight:bold">3.CRM제공 팝업호출</p></a><br><br>

<form name="pssoForm" id="pssoForm" method="post">
	<input type="text" name="id" id="id" value="pssotest01">
	<input type="text" name="password" id="password" value="123qwe">
	<input type="text" name="clientkey" id="clientkey" value="746KCkTXDM">
	<input type="text" name="url" id="url" value="http://tb.mimo.kt.com/sampleJs.do">
	<input type="text" name="site" id="site" value="tb.mimo.kt.com">
	<input type="text" name="userId" id="userId" value="admin2">
</form>
<br><br>
...
<tr style="background:white">
	<td>예제</td>
	<td>
<form name="loginForm" method="post" action="/sampleJs.do" onsubmit="return showValidate('loginForm', 'alert', '입력 오류가 있습니다.')">
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="requiredSampleForm" method="post" action="/sampleJs.do" onsubmit="return showValidate('requiredSampleForm', 'dialog', '입력 오류가 있습니다.')">
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="mustcheckSampleForm" method="post" action="/sampleJs.do" onsubmit="return showValidate('mustcheckSampleForm', 'dialog', '입력오류를 확인하십시오.')">
				        성별
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="mustnumSampleForm" method="post" action="/sampleJs.do" onsubmit="return showValidate('mustnumSampleForm', 'dialog', '다시 입력하세요.')">
				        나이
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="ncompareSampleForm" method="post" action="/sampleJs.do" onsubmit="return showValidate('ncompareSampleForm', 'dialog', '다시 입력하세요.')">
				        18금 통과 나이는?
				          <input type="text" name="age"
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="emailSampleForm" method="post" action="/sampleJs.do" onsubmit="return showValidate('emailSampleForm', 'dialog', '다시 입력하세요.')">
				        이메일
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="dateSampleForm" method="post" action="/sampleJs.do" onsubmit="return showValidate('dateSampleForm', 'dialog', '다시 입력하세요.')">
				        시작일
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="regexpSampleForm" method="post" action="/sampleJs.do" onsubmit="return showValidate('regexpSampleForm', 'dialog', '다시 입력하세요.')">
				        ID
	...
	<td>
		...
		<tr style="background:white">
			...
			<td>
				...
				<form name="dayTermLimitForm" method="post" action="/sampleJs.do" onsubmit="return showValidate('dayTermLimitForm', 'dialog', '조회기간 오류')">
				        조회 기간 : 
				          <input type="text" name="startDate"
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="textLimitForm" method="post" action="/sampleJs.do" onsubmit="return showValidate('textLimitForm', 'dialog', '입력제한 오류')">
					<textarea name="note"
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="shotypeAlertSampleForm" method="post" action="/sampleJs.do" onsubmit="return showValidate('shotypeAlertSampleForm', 'alert', '잘못했을껄?')">
				<table>
				<tr>
				    <td align="right">
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>예제</td>
			<td>
				<form name="shotypeDialogSampleForm" method="post" action="/sampleJs.do" onsubmit="return showValidate('shotypeDialogSampleForm', 'dialog', '오류다이얼로그제목')">
				<table>
				<tr>
				    <td align="right">
				        <span style="color:red">*</span>ID
...
<tr style="background:white">
	...
	<td>
		...
		<tr style="background:white">
			<td>묵시적인 지정 예제</td>
			<td>
				<form name="shotypeEtc1SampleForm" method="post" action="/sampleJs.do" onsubmit="return showValidate('shotypeEtc1SampleForm', 'verror', '입력된 내용에 오류가 존재합니다.')">
				<table>
		...
		<tr style="background:white">
			<td>명시적인 지정 예제</td>
			<td>
				<form name="shotypeEtc2SampleForm" method="post" action="/sampleJs.do" onsubmit="return showValidate('shotypeEtc2SampleForm', 'verror', '입력된 내용에 다음과 같은 오류가 존재합니다.')">
				<table>
				<tr>
				    <td align="right">
				        <span style="color:red">*</span>ID
...
upload.img.url : <mimo:config key='upload.img.url'/>