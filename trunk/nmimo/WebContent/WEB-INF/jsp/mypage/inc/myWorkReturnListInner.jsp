...
<table summary="리스트" class="ListTable"  id="myWorkReturnListTable" name="myWorkReturnListTable">
	<caption>리스트</caption>
	<thead>
		<tr>
	...
	<tbody>
		...
		<tr>
			...
			<td class="l"><a href="#" onclick="javascript:doPostDetail('${data.wrkId}','/myWork/returnListDetail.do');">${data.msgTitleNm}</a></td>
			<td>${data.cretDt}</td>
			<td>${data.rsrvDt}</td>
