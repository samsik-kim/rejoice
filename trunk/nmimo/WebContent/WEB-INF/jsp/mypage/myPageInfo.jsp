...
<div class="help">
	...
	<span><a href="javascript:Common.centerPopupWindow('/user/popup/listInfoDetailPop.do','window',{width:421,height:423,scrollBars:'no'});" class="btn_help"><strong>화면도움말</strong></a></span>
</div>
...
<div style="float:right; width:500px;">
	<table summary="리스트" class="WriteTable">
		...
		<tbody>
			...
			<tr>
				...
				<td class="l">${viewInfo.basApvrNm}</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="l">${viewInfo.tstTrm1No}</td>
			</tr>
			<tr>
				<th scope="row" class="l">시험발송번호2</th>
				<td class="l">${viewInfo.tstTrm2No}</td>
			</tr>
			<tr>
				<th scope="row" class="l">시험발송번호3</th>
				<td class="l">${viewInfo.tstTrm3No}</td>
			</tr>
			<tr>
				<th scope="row" class="l">시험발송번호4</th>
				<td class="l">${viewInfo.tstTrm4No}</td>
			</tr>
			<tr>
	...
	<p class="btnR" style=" padding-bottom:30px">
		<a href="#" onclick="javascript:doPostDetail('','/myPage/infoModify.do');" class="btn_red"><strong>수정</strong></a>
