...
<div class="top">
	...
	<!-- UserMenu -->
	<div class="userMenu">
		<p>CC1${user_session.userId}님 로그인 중</p>
		<ul>
...
<div class="gnb" style="width: 700px">
		...
		<ul id="nav">
			...
			<li>
				<c:if test="${menuId eq 'mynav4'}">				
					<a href="#" onclick="javascript:doPost('/stats/list.do', '4', '40');" onmouseover="javascript:qiehuan(4);" id="mynav4" class="nav_on" style='cursor:hand;'><span>통계</span></a>
				</c:if>
				<c:if test="${menuId ne 'mynav4'}">				
					<a href="#" onclick="javascript:doPost('/stats/list.do', '4', '40');" onmouseover="javascript:qiehuan(4);" onmouseout="javascript:qiehuanOut(4);" id="mynav4"  class="nav_off" style='cursor:hand;'><span>통계</span></a>
				</c:if>						
			</li>
		</ul>
	</div>
	...
	<div id="menu_con">
		...
		<div id="qh_con2" style="display: none; margin-left: 275px">
			<ul>
		...
		<div id="qh_con3" style="display: none; margin-left: 270px">
			<ul>
				...
				<li class=menu_dot>|</li>
				<li><a href="#" onclick="javascript:doPost('/review/bannerList.do', '3', '33');" id="mycon33"><span>배너 관리</span></a></li>
				<li class=menu_dot>|</li>
				<li><a href="#" onclick="javascript:doPost('/review/reservationList.do', '3', '34');" id="mycon34"><span>사전 예약</span></a></li>
			</ul>
		</div>
		<div id="qh_con4"></div>
	</div>
