...
<body>
	<div id="popup_area_440">
		...
		<h1 class="mt25">T store Cash 차감 대상 검색</h1>
		<table class="pop_tabletype01">
			<colgroup><col width="30%;"><col width="70%;"></colgroup>
			<tr>
				<th>회원검색</th>
				<td>ID <input id="searchText" name="sub.searchText" type="text" class="txt" value="${sub.searchText }"/><a class="btn" href="#" id="searchBtn"><strong>검색</strong></a>
			</tr>
		</table>
	<c:choose>
	...
	<c:otherwise>
		...
		<div class="pop_btn" >
			<a class="btn" href="#" id="refundBtn"><strong>확인</strong></a>
			<a class="btn" href="#" id="exitBtn"><strong>닫기</strong></a>
		</div>
	</c:otherwise>
	</c:choose>
