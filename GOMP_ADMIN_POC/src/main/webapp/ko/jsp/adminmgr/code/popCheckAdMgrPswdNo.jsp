...
<script language="javascript">
	...
	<div id="popup_area_440">
		<p class="mb10"> 로그인한 현 운영자의 ID에 대한 비밀번호를 입력해주세요.</p>
        <div class="box03">
        	<p class="mt20"><label for="#"><strong>비밀번호</strong></label>
		...
		<div class="pop_btn" >
			<a class="btn" href="javascript:funcPopCheckPswdNo();"><strong>확인</strong></a>
            <a class="btn" href="javascript:funcClose();"><strong>닫기</strong></a>
		</div>
	</div>
	</s:form>
