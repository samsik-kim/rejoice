...
<form id="loginFrm" name="frm" method="post">
	...
	<div id="container" class="none_bg">
		...
		<div id="login_area">
			...
			<p class="jointxt"><a href="javascript:gotoPage('CHECKBEFOREREGIST');">회원가입</a> <span class="txtcolor11">|</span> <a href="${CONF['omp.common.url-prefix.https.dev']}${pageContext.request.contextPath }/login/findId.omp">아이디/비밀번호 찾기</a></p>
