	...
	<div class="viewbox" style="overflow-x:hidden;">
		<div class="imgbox1 fltl">
			...
			<ul class="pad_b10 overh cb">
				<li class="fltl"><a href="javascript:clickTab('PreviewDesc');"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/pop/pretab_01_on.gif'/>" alt="상품설명/사용후기" id="PreviewDesc" /></a></li>
				<li class="fltl"><a href="javascript:clickTab('PreviewImg');"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/pop/pretab_02.gif'/>" alt="미리보기" id="PreviewImg" /></a></li>
			</ul>
