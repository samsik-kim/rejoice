		...
		<div id="maincontent">
			...
			<div id="mcleft">   
				...
				<c:if test="${empty MEMBER_SESSION}">
					<div class="mlogin">
						...
						<ul>
							...
							<li class="txt01"><a href="javascript:gotoPage('CHECKBEFOREREGIST');"><span class="txtcolor03 txt_bold">회원가입</span></a></li>
							<li class="txt02"><a href="${CONF['omp.common.url-prefix.https.dev']}${pageContext.request.contextPath }/login/findId.omp">아이디/비밀번호 찾기</a></li>
						</ul>
						</form>
					</div>   
				</c:if>
				<c:if test="${not empty MEMBER_SESSION}">
					...
					<input type="hidden" id="saleSearchType" name="content.saleSearchType" value="">
						<p class="member"><strong><span class="txtcolor03"><g:html  value='${MEMBER_SESSION.mbrId}' /></span><strong>님</strong> (<g:text format="L##"><gc:html code='${member.mbrCatCd}' /></g:text><gc:html code='${member.mbrClsCd}' />회원)</p>
						<ul class="state">
							...
							<li class="sta03"><span>전일판매현황</span>&nbsp;<a href="<c:url value='/settlement/dailysale/dailySaleList.omp'/>"><g:text value="${beforeSaleCnt}" format="R#,###,###,###" /></a>건<br /></li>
							<li class="sta04"><span>전일판매매출</span>&nbsp;<a href="<c:url value='/settlement/dailysale/dailySaleList.omp'/>"><g:text value="${beforeSaleSum}" format="R#,###,###,###"  /></a>원</strong></li>
						</ul>
						<ul class="proli">
			...
			<div id="mcright">
				<div class="guide1">
					...
					<p class="gtxt"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/main/gtxt_01.gif'/>" alt="직접 개발한 App을 판매해보세요. 쉽고, 간편하게 등록하고, 관리 할 수 있습니다." /></p>
				...
				<div class="guide2">
					...
					<p class="gtxt"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/main/gtxt_02.gif' />" alt="직접 개발한 App을 위해 유해성 검증 및 단말동작 검증 등의 서비스를 제공합니다. " /></p>
				...
				<div class="guide3">
					...
					<p class="gtxt"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/main/gtxt_03.gif' />" alt="판매중인 상품에 대한 판매현황을 확인하고, 매월 정산 리포트를 제공합니다." /></p>
