...
<body>
	...
	<h1 class="fl pr10 mb0">바이너리 관리</h1>
	<p>Shop Client의 Client,ARM 바이너리를 관리할 수 있습니다.</p>
	...
	<p class="fl mt20">총 <g:html value="${sc.page.totalCount}"/>개의 바이너리 형태가 등록되어 있습니다.</p>
...
<c:choose>
	<c:when test="${coreAppList == null}">
		<tr>
			<td colspan="7"><gm:html value="jsp.device.scmng.scVersionList.msg.plzSearch"/></td>
		</tr>
	</c:when>
	<c:when test="${empty coreAppList}">
		<tr>
			<td colspan="7"><gm:html value="jsp.device.scmng.scVersionList.msg.emptyResult"/></td>
		</tr>
	</c:when>
	<c:otherwise>
	...
	<p class="fl mt05"><a class="btn_s" href="javascript:doChangeStatus('DP005403')"><span>상용으로</span></a> <a class="btn_s" href="javascript:doChangeStatus('DP005402')"><span>테스트로</span></a></p>
