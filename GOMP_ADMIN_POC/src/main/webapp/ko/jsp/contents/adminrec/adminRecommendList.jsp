...
<script language='javascript'>
	...
	function funcUpdateAdminRecommend() {
		...
		if(chkLen > 0){
			...
			alert("<gm:string value='jsp.contents.adminrec.adminRecommend.msg.update_no'/>");
			return;
		}
...
*/
	...
	$(document).ready( function()	{
		...
		$( "#checkAll" ).click( function()	{
			...
			<div id="location">
				Home &gt; 컨텐츠관리 &gt; 추천관리 &gt; <strong>추천관리</strong> 
			</div><!-- //location -->

			<h1 class="fl pr10">추천관리</h1>
			<p>운영자 추천 컨텐츠를 관리 할수 있다</p>
