...
<script type="text/javascript">
	...
	var funcAnnounceList = function()	{
		...
		<div id="location">
			Home &gt; 컨텐츠관리 &gt; <strong>서비스 점검관리</strong> 
		</div><!-- //location -->
		...
		<p class="fl mt25"><a class="btn" href="javascript:deleteAnnounce('${dpAnoc.anocSeq}');"><span>삭제</span></a></p>
		<p class="btn_wrap text_r mt25"><a class="btn" id="btnSubmit" href="javascript:funcProcessAnnounce()"><span>저장</span></a>
			<a class="btn" href="javascript:funcAnnounceList();"><span>목록</span></a></p>
		</s:if>
		<s:else>
		<p class="btn_wrap text_r mt25"><a class="btn" id="btnSubmit" href="javascript:funcProcessAnnounce()"><span>저장</span></a>
			<a class="btn" href="javascript:funcAnnounceList();"><span>목록</span></a></p>
