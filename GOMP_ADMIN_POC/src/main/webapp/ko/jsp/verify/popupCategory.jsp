...
function ctgrClick(){
	$("#testCategory li").each(function(){
		$(this).click(function(){
			...
			$("#explanation").attr("value",$("#explain"+mId).val());
			if($("#useYn"+mId).val()=='Y'){
...
<s:form id="ctgrForm" name="ctgrForm" theme="simple" method="post" enctype="multipart/form-data">
	...
	<div id="popup_area_810">
		...
		<div class="box04" style="overflow:hidden;">
			<p class="fl mr20"><strong>카테고리</strong></p>
		...
		<table class="pop_tabletype01">
			...
			<tr>
				<th>사용유무</th>
				<td><input type="radio" id="useY" name="use" value="Y" checked/> 예 <input type="radio" id="useN" name="use" value="N" v:mustcheck="1" m:mustcheck="<gm:tagAttb value='jsp.certifymgr.popupCategory.msg.use'/>"/> 아니오</td>
			</tr>
		</table>
		<div class="pop_btn" >
			<a class="btn" href="javascript:saveCtgr();"><strong>추가/수정</strong></a>
			<a class="btn" href="javascript:closeCtgr();"><strong>닫기</strong></a>
		</div>
	</div>
	</s:form>
</body>