...
<div id="contents_area">
	...
	<div id="contents">
		...
		<div class="mpbox bgimg14">
			<div class="txttype12">
				<p class="txttype13"><span class="txtcolor03"><g:html value="${MEMBER_SESSION.mbrId}"/> / <g:html value="${transferInfo.compNm}"/></span>님의 이메일 주소 <span class="txtcolor03 uline"><g:html value="${profileInfo.emailAddr}"/></span>로<br />인증 확인 이메일이 발송 되었습니다.</p>
		...
		<div class="btnarea mar_t30">
			<a href="${CONF['omp.common.url-prefix.http.dev']}${pageContext.request.contextPath }/main/main.omp"><img alt="확인" src="<c:url value="/${ThreadSession.serviceLocale.language}/images/common/btn_confirm.gif"/>"></a>
		</div>
		...
		<div class="mpbox bgimg16">
			<div class="txttype11">
				...
				<dl class="dlist06 pad_b10">
					<dt>변경 후</dt>
					<dd>유료회사회원 (<gc:html code="${transferInfo.bizCatCd}"/>)</dd>
				</dl>
			</div>
		</div>
		<div class="btnarea mar_t30">
