...
<input type="hidden" id="sc" name="" value="<g:printBean prefix='sc.' value='${sc}' outType='qs'/>" />
	<div id="popup_area_440">
		...
		<div class="pop_btn" >
			<a class="btn_s" href="javascript:email_send();"><strong style="cursor:pointer;">발송하기</strong></a>
			<a class="btn_s" href="javascript:self.close();"><strong style="cursor:pointer;">취소</strong></a>
		</div>
	</div>
</form>