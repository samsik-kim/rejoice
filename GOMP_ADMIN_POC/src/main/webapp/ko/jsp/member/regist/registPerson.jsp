...
<form name="registPerson" id="registPerson" method="post">
		...
		<div class="utbox">
			...
			<p class="pbult02">
				<label for="twid">타이완 ID</label>
				&nbsp;   
				<input type="text" id="psRegNo" name="member.psRegNo" class="w168" value="${twId}"
				v:required='trim' m:required="<gm:tagAttb value='jsp.member.regist.registPerson.msg.twid03'/>" 
