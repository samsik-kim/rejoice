...
<div id="contents_area" class="ut_area">
	...
	<form method="post" id="registAgree" name="registAgree" action="<c:url value='/member/registJoinForm.omp'/>">
		...
		<p class="pad_t7 txtcolor05"><input type="checkbox" name="useagree" id="useagree" v:mustcheck="1" m:mustcheck="<gm:string value='jsp.member.regist.msg.check01'/>"/> <label for="useagree">이용약관에 동의합니다.</label></p>
