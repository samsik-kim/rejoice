			...
			<form id="foreignerForm" name="foreignerForm" method="post">
				<table summary="회원기본정보 입력 항목입니다">
					...
					<tbody>   
						...
						<tr>
							<th scope="row" class="tit03">여권번호</th>
						...
						<tr>
							<th scope="row"><span>*</span> <label for="nation">국가</label></th>
							<td>
						...
						<tr>
							...
							<td><input type="text" id="telNo" name="member.telNo" class="w180" onkeyup="checkNumber(this)"
								...
								v:regexp="[\d]+" m:regexp="<gm:tagAttb value='jsp.member.join.msg.ph01'/>" /> <span class="txtcolor01"> &nbsp;* “ㅡ” 을 생략하고 국가번호와 지역번호를 포함하여 입력해 주세요.</span></td><!-- text추가 -->
							</td>
						</tr>
						<tr>
							...
							<td>
								...
								v:text8_limit="20" m:text8_limit="<gm:tagAttb value='jsp.member.join.msg.hp02'/>"
							 	v:required='trim' m:required="<gm:tagAttb value='jsp.member.join.msg.hp01'/>" /> <span class="txtcolor01"> &nbsp;* “ㅡ” 을 생략하고 국가번호를 포함하여 입력해 주세요.</span></td><!-- text추가 -->
							 </td>
						</tr>
						<tr>
