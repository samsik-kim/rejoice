...
<input type="hidden" name="notice.page.no" value="${notice.page.no}"/>
	<table class="list_table list_table_v">
		...
		<tr>
			...
			<th class="t_th"><img src="${pageContext.request.contextPath }/${ThreadSession.serviceLocale.language}/images/pw/th_wdate02.gif" alt="작성일" /></th>
	...
	<div class="btn text_r">
		<a href="javascript:searchNoticeList();" class="arr"><img src="${pageContext.request.contextPath }/${ThreadSession.serviceLocale.language}/images/pw/btn_list.gif" alt="목록" /></a>
	</div>
</form>
</div>
</body>
