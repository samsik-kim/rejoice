...
<div class="txtr mar_b5" name="divBtnArea" id="divBtnArea${resultMap.subContentsCnt}">
	<a href="javascript:removeForm('divSubContent', 'divBtnArea' , ${resultMap.subContentsCnt});"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/pm/btn_del03.gif' />" alt="刪除" /></a>
</div>
<div class="tstyleA mar_b22" id="divSubContent${resultMap.subContentsCnt}" name="divSubContent">
</c:if>
