				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="javascript:removeTempRunFile('editForm${resultMap.subContentsCnt}', '${resultMap.subContentsCnt}');"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/pm/btn_del02.gif'/>" alt="刪除" /></a>
						</td>
					</tr>
					<tr>
						<td class="lh160">
