...
<script type="text/javascript">
	...
	var addCtgr = function() {
		...
		/*    <li id="FAQ3001" name="ctgrDepth" value="1" >NAME</li>    */
	...
	var saveCtgr = function() {
		...
		<s:if test="ctgrCd == @com.omp.admin.common.Constants@CTGR_FAQ_SC">
		<h1 class="fl pr10">使用者常見問題類別管理</h1>
		<p>可附加／修改／刪除使用者常見問題管理類別.</p>
		</s:if>
		<s:if test="ctgrCd == @com.omp.admin.common.Constants@CTGR_FAQ_DEV">
		<h1 class="fl pr10">開發商常見問題類別管理</h1>
		<p>可附加／修改／刪除開發商常見問題管理類別.</p>
		</s:if>
		...
		<div id="adm_cate">
			<dl class="mr15">
				...
				<dd>
					...
					<p class="fr">
						<a class="btn_s" href="javascript:updCtgr();"><span>變更</span></a>
						<a class="btn_s" href="javascript:delCtgr();"><span>刪除</span></a>
					</p>
				</dd>

				<dd class="mt05">
					<input id="ctgrText" type="text" name="ctgrText" class="txt" style="width:87%;" 
						v:required="trim" m:required="<gm:string value="jsp.community.faq.categoryList.msg.check_ctgrtext"/>"  />
					<a class="btn_s" href="javascript:addCtgr();"><span>新增</span></a>
					<p class="btn_wrap text_r mt25">
						<a class="btn" href="javascript:saveCtgr();"><span>儲存</span></a>
					</p>
				</dd>
