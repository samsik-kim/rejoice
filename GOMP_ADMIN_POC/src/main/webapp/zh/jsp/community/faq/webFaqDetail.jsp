...
<input type="hidden" id="no" name="faq.page.no" value="${faq.page.no}"/>
	<table class="list_table list_table_v">
		...
		<tr>
			<th class="t_th"><img src="${pageContext.request.contextPath }/${ThreadSession.serviceLocale.language}/images/pw/th_cl02.gif" alt="category" /></th>
	...
	<div class="btn text_r">
		<a href="javascript:searchFaqList();" class="arr"><img src="${pageContext.request.contextPath }/${ThreadSession.serviceLocale.language}/images/pw/btn_list.gif" alt="list" /></a>
	</div>
</form>
</div>
</body>
