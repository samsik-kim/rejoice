...
<s:form id="caseForm" name="caseForm" theme="simple" method="post" enctype="multipart/form-data">
	...
	<div id="popup_area_810">
		...
		<table class="pop_tabletype01">
			...
			<tr>
				<th>使用與否</th>
				<td><input type="radio" id="useY" name="use" value="Y" checked/> 使用 <input type="radio" id="useN" name="use" value="N" v:mustcheck="1" m:mustcheck="<gm:tagAttb value='jsp.certifymgr.popupCase.msg.use'/>" /> 不使用</td>
			</tr>
		</table>
		<div class="pop_btn" >
			<a class="btn" href="javascript:saveCase();"><strong>確定</strong></a>
			<a class="btn" href="javascript:closeCase();"><strong>關閉</strong></a>
		</div>
	</div><!-- //contents -->
	</s:form>
</body>