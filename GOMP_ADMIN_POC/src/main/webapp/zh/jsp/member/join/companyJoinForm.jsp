			...
			<div class="tstyleA mar_b22">
				<table summary="基本資料">
					...
					<tbody>
						...
						<tr>
							<th scope="row" class="tit03">統一編號</th>
						...
						<tr> 
							...
							<td><input type="password" id="mbrPw" name="member.mbrPw" class="w180"
								...
								v:reqexpwwith m:reqexpwwith="<gm:tagAttb value='jsp.member.join.msg.pw02'/>"/><span class="txtcolor01"> &nbsp;* 需包含大小寫英文、數字、特殊符號共6~16碼(不可有空白)</span></td>
						</tr>
						<tr>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<input type="hidden" name="member.opTelNo" id="opTelNo"/><span class="txtcolor01"> &nbsp;* 請省略"-"並只要輸入輸字</span>
							</td>
						</tr>
						<tr>
							...
							<td class="bgnone">
								...
								<input type="hidden" value="<g:tagAttb value='${member.mbrClsCd}'/>" name="member.mbrClsCd" id="mbrClsCd"/><span class="txtcolor01"> &nbsp;* 請省略"-"並只要輸入輸字</span>
							</td>
						</tr>
					</tbody>
				</table>
