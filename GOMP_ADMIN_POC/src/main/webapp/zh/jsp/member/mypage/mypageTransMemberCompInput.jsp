...
<div id="contents_area">
	...
	<form id="frmCompInput" name="frmCompInput" method="post">
		<h4 class="h43"><img alt="確認公司資訊" src="<c:url value="/${ThreadSession.serviceLocale.language}/images/mp/mp_subtitle02.gif"/>"></h4>
		...
		<div class="mpbox bgimg12">
			<div class="txttype09">
				<dl class="dlist04">
					<dt><label for="businame">公司名稱</label></dt>
					<dd>
				...
				<dl class="dlist04 mar_b5">
					<dt><label for="comnum">统一編號</label></dt>
					<dd>
		...
		<div class="btnarea mar_t30">
			<a href="javascript:compInfoOnClick();"><img alt="確定" src="<c:url value="/${ThreadSession.serviceLocale.language}/images/common/btn_confirm.gif"/>"></a>
