...
<form id="loginFrm" name="frm" method="post">
	...
	<div id="container" class="none_bg">
		...
		<div id="login_area">
			...
			<p class="jointxt"><a href="javascript:gotoPage('CHECKBEFOREREGIST');">註冊會員</a> <span class="txtcolor11">|</span> <a href="${CONF['omp.common.url-prefix.https.dev']}${pageContext.request.contextPath }/login/findId.omp">查詢帳號及密碼</a></p>
			<div class="loginbox bgimg05">
				...
				<p class="pad_b23"><img src="<c:url value='/${ThreadSession.serviceLocale.language}/images/common/login_txt02.gif'/>" alt="若尚未申請帳號, 請註冊後使用!" /></p>
				<p class="pad_b2">
