...
//<![CDATA[
	...
	$(document).ready(function(){
		...
		//처리상태 작업
		$("form[name=searchForm] input[name=remittanceSS\\.rmtEndCd]").each(function (idx, obj) {
			obj.checked = obj.value == '${remittanceSS.rmtEndCd}'; 
		});
		//처리상태 작업
			...
			<table class="tabletype01">
				...
				<tr>
					...
					<td class="align_td line2_5">					
						<label for="#">匯款狀態</label>
						<input type="radio" class="ml10" id="rmtEndCd" name="remittanceSS.rmtEndCd" value="" /> 全部
						<input type="radio" class="ml10" id="rmtEndCd" name="remittanceSS.rmtEndCd" value="PD004124"/> 匯款完畢
						<input type="radio" class="ml10" id="rmtEndCd" name="remittanceSS.rmtEndCd" value="PD004122"/> 再次匯款
						<input type="radio" class="ml10" id="rmtEndCd" name="remittanceSS.rmtEndCd" value="PD004123"/> 匯款失敗
						<input type="radio" class="ml10" id="rmtEndCd" name="remittanceSS.rmtEndCd" value="PD004121"/> 次月處理
						<br />
				...
				<c:otherwise>
					...
					<tr>
						...
						<c:when test="${(remittance.rmtEndCd eq 'PD004122' ||remittance.rmtEndCd eq 'PD004123') && remittance.rmtReason ne '' }"><!-- 재송금, 송금포기 상태이면서 송금결과사유 존재시   -->
							<a class="btn_s" id="viewPage" href="#" onClick="JavaScript:popUpPage('${remittance.saleYm}','${remittance.rmtReqYyyymm}','${remittance.mbrNo}','${remittance.adjYn}')"><span>詳細內容</span></a>
