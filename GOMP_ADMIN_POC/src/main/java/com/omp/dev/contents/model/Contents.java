...
public class Contents extends CommonModel implements Pagenateable, TotalCountCarriable {
	...
	private		String 		updApplyDivisionCd; 
	...
	/**
	 * @return the updApplyDivisionCd
	 */
	public String getUpdApplyDivisionCd() {
		return updApplyDivisionCd;
	}
	/**
	 * @param updApplyDivisionCd the updApplyDivisionCd to set
	 */
	public void setUpdApplyDivisionCd(String updApplyDivisionCd) {
		this.updApplyDivisionCd = updApplyDivisionCd;
	}
	/**
	 * @return the insBy
	 */
