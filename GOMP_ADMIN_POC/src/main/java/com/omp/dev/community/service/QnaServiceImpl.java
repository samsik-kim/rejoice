...
public class QnaServiceImpl extends AbstractService implements QnaService {
	...
	public void addQna(HttpServletRequest req, Qna qna) {
		...
		try {
			...
			mail.setSubject(LocalizeMessage.getLocalizedMessage("[Whoopy 개발자센터] 회원님의 고객문의 접수 안내입니다."));
	...
	public List<Ctgr> getCategoryList()	{
		...
		try	{
    		...
    		log.error("Category list inquiry error.", e);
    		throw new ServiceException("Category list inquiry error.", e);
        }
