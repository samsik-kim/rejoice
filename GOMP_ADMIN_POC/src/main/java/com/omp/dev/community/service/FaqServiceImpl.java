...
public class FaqServiceImpl
	...
	public List getFaqList(Faq faq) throws ServiceException {
		...
		try {
			...
			logger.error("FaqList inquiry Error", e);
			throw new ServiceException("faq list inquiry error", e);
		}
		return result;
	}
	...
	public void updateFaqHit(Faq faq) throws ServiceException {
		try {
			...
			logger.error("faq inquiry hit number error", e);
			throw new ServiceException("faq inquiry hit number error", e);
		}
