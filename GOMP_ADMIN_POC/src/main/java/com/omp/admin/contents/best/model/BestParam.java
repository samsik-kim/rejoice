 ...
 *
 */
package com.omp.admin.contents.best.model;
 ...
 * @version 0.1
 */
public class BestParam implements Pagenateable {
	...
	//추가
	private String payChkCnt;
	private String payTotCnt;
	
	// paging
	private PagenateInfoModel page = new PagenateInfoModel(50);
	...
	public String getPayChkCnt() {
		return payChkCnt;
	}

	public void setPayChkCnt(String payChkCnt) {
		this.payChkCnt = payChkCnt;
	}

	public String getPayTotCnt() {
		return payTotCnt;
	}

	public void setPayTotCnt(String payTotCnt) {
		this.payTotCnt = payTotCnt;
	}
